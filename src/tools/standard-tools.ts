...
export const evaluationTools: ToolDefinition[] = [
  {
    ...
    annotations: {
      ...
      category: 'evaluation' as ToolCategory,
      readOnlyHint: false
    },
    inputSchema: {
      type: 'object',
...
export const debugTools: ToolDefinition[] = [
  {
    ...
    annotations: {
      ...
      category: 'debug' as ToolCategory,
      readOnlyHint: true
    },
    inputSchema: {
      type: 'object',
 ...
 */
export const allStandardTools: ToolDefinition[] = [
  ...chromeTools,
  ...extensionTools,
  ...evaluationTools,
  ...interactionTools,

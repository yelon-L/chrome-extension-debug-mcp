...
export function parseArguments(version: string, argv = process.argv): CLIOptions {
  ...
  return parser.parseSync() as CLIOptions;
}

export function logStartupMessage(options: CLIOptions, version: string): void {

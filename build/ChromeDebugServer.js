...
export class ChromeDebugServer {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                ...
                switch (request.params.name) {
                    case 'launch_chrome':
                        return await this.handleLaunchChrome(args);
                    case 'attach_to_chrome':
                        return await this.handleAttachToChrome(args);
                    ...
                    case 'new_tab':
                        return await this.handleNewTab(args);
                    case 'switch_tab':
                    ...
                    case 'get_extension_logs':
                        return await this.handleGetExtensionLogs(args);
                    case 'inject_content_script':
                        return await this.handleInjectContentScript(args);
                    case 'content_script_status':
                        return await this.handleContentScriptStatus(args);
                    case 'list_extension_contexts':
                        return await this.handleListExtensionContexts(args);
                    case 'switch_extension_context':
                        return await this.handleSwitchExtensionContext(args);
                    case 'inspect_extension_storage':
                        return await this.handleInspectExtensionStorage(args);
                    ...
                    case 'performance_get_insights':
                        return await this.handlePerformanceGetInsights(args);
                    case 'performance_list_insights':
                        return await this.handlePerformanceListInsights(args);
                    // Phase 1.2: Emulation Tools
                    case 'emulate_cpu':
                        return await this.handleEmulateCPU(args);
                    case 'emulate_network':
                        return await this.handleEmulateNetwork(args);
                    ...
                    case 'hover_element':
                        return await this.handleHoverElement(args);
                    case 'drag_element':
                        return await this.handleDragElement(args);
                    case 'fill_form':
    ...
    async handleAttachToChrome(args) {
     ...
     */
    async run(transportType = 'stdio', config) {
...
//# sourceMappingURL=ChromeDebugServer.js.map